...
export default function Keyboard({
  ...
  return (
    <div className="p-6 bg-gradient-to-b from-muted to-muted/80 rounded-2xl shadow-2xl border border-border">
      {/* Function Keys Row */}
      ...
      {selectedKey && (
        <div className="mt-6 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-accent border-2 border-primary/30 rounded-lg">
            <span className="text-sm text-primary mr-2">Selected:</span>
            <kbd className="px-3 py-1 bg-background border border-primary/20 rounded font-mono text-lg font-semibold text-primary">
