...
/** Words that should never be auto-learned (key names, common artifacts) */
const BLOCKLIST = new Set([
  "esc", "escape", "tab", "enter", "return", "delete", "backspace",
  "shift", "ctrl", "control", "alt", "option", "cmd", "command", "meta",
  "space", "capslock", "fn", "insert", "home", "end", "pageup", "pagedown",
...
function extractCorrections(originalText, fieldValue, existingDictionary) {
  ...
  for (const [origWord, correctedWord] of subs) {
    ...
    if (BLOCKLIST.has(normalizedCorrected)) continue;
